    ...
    >
      ...
      <header dir="ltr" className="relative z-10 mx-auto flex h-24 w-full max-w-7xl items-center justify-between border-b border-[#eef2f7]">
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://wa.me/"
            className="hidden h-12 items-center justify-center gap-2 rounded-full bg-[#0c023c] px-5 text-sm font-bold text-white shadow-[0_12px_28px_rgba(12,2,60,0.16)] sm:inline-flex"
